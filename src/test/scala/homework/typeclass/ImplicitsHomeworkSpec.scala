...
import homework.typeclass.ImplicitsHomework.SuperVipCollections4s._
import homework.typeclass.ImplicitsHomework.SuperVipCollections4s.syntax._
import homework.typeclass.ImplicitsHomeworkSpec.TestValue
...
class ImplicitsHomeworkSpec extends AnyFreeSpec with Matchers {
  ...
  "Iterate2 instances provided" - {
    "for Map" in {
      assertCompiles(
        """import homework.typeclass.ImplicitsHomework.SuperVipCollections4s._
          |import homework.typeclass.ImplicitsHomework.SuperVipCollections4s.instances._
          |
  ...
  "TwitCache" - {
    import homework.typeclass.ImplicitsHomework.MyTwitter._
